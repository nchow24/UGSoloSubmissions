# class HashLinear is a class of a linear probing hash table containing _MapEntry.Pair()
#
...
class HashLinear:
    ...
    #returns index of table that holds key if key is in table, else -2
